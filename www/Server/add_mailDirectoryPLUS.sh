...
if test -d "/var/mail/$1"; then
	...
	sudo /usr/bin/maildirmake /var/mail/$1/Maildir
	...
	sudo /usr/sbin/userdb $1@$2.myshop.itinet.fr set uid=5000 gid=5000 home=/var/mail/$1 mail=/var/mail/$1/Maildir imappw=$3
