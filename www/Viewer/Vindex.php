          ...
          <div class="row">
            ...
            <div class="col-md-6 mb48">
              <div class="oe_demo img img-responsive shadow">
                <iframe allowfullscreen="allowfullscreen" frameborder="0" height="300" src="//www.youtube.com/watch?v=sCfJrHGn_Cs" width="500"></iframe>
              </div>
            </div>
            <div class="col-md-6">
    ...
    <div class="container marketing">
      ...
      <div class="row">
        <div class="col-lg-4">
          <img class="img-circle" src="./Viewer/Images/bleu.png" alt="Generic placeholder image" style="width: 140px; height: 140px;">
          <h2>Modèle 1</h2>
          <p>Description du modèle 1</p>
          <p><a class="btn btn-default" href="#" role="button">En savoir plus &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
          <img class="img-circle" src="./Viewer/Images/rouge.png" style="width: 140px; height: 140px;">
          <h2>Modèle 2</h2>
          <p>Description du modèle 2</p>
          <p><a class="btn btn-default" href="#" role="button">En savoir plus &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
          <img class="img-circle" src="./Viewer/Images/vert.png" alt="Generic placeholder image" style="width: 140px; height: 140px;">
          <h2>Modèle 3</h2>
